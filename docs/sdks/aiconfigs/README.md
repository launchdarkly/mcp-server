...
* [getMetrics](#getmetrics) - Get AI Config metrics
* [getMetricsByVariation](#getmetricsbyvariation) - Get AI Config metrics by variation
* [deleteRestrictedModels](#deleterestrictedmodels) - Remove AI models from the restricted list
* [addRestrictedModels](#addrestrictedmodels) - Add AI models to the restricted list
* [listModels](#listmodels) - List AI model configs
* [createModelConfig](#createmodelconfig) - Create an AI model config
...
async function run() {
  const result = await launchDarkly.aiConfigs.getMetrics({
    ldAPIVersion: "beta",
    projectKey: "<value>",
    configKey: "<value>",
    from: 291253,
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { aiConfigsGetMetrics } from "@launchdarkly/mcp-server/funcs/aiConfigsGetMetrics.js";
...
async function run() {
  const res = await aiConfigsGetMetrics(launchDarkly, {
    ldAPIVersion: "beta",
    projectKey: "<value>",
    configKey: "<value>",
    from: 291253,
...
**Promise\<[components.Metrics](../../models/components/metrics.md)\>**
...
async function run() {
  const result = await launchDarkly.aiConfigs.getMetricsByVariation({
    ldAPIVersion: "beta",
    projectKey: "<value>",
    configKey: "<value>",
    from: 418619,
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { aiConfigsGetMetricsByVariation } from "@launchdarkly/mcp-server/funcs/aiConfigsGetMetricsByVariation.js";
...
async function run() {
  const res = await aiConfigsGetMetricsByVariation(launchDarkly, {
    ldAPIVersion: "beta",
    projectKey: "<value>",
    configKey: "<value>",
    from: 418619,
...
**Promise\<[components.MetricByVariation[]](../../models/.md)\>**
...
async function run() {
  await launchDarkly.aiConfigs.deleteRestrictedModels({
    ldAPIVersion: "beta",
    projectKey: "default",
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { aiConfigsDeleteRestrictedModels } from "@launchdarkly/mcp-server/funcs/aiConfigsDeleteRestrictedModels.js";
...
async function run() {
  const res = await aiConfigsDeleteRestrictedModels(launchDarkly, {
    ldAPIVersion: "beta",
    projectKey: "default",
    restrictedModelsRequest: {
      keys: [
...
async function run() {
  const result = await launchDarkly.aiConfigs.addRestrictedModels({
    ldAPIVersion: "beta",
    projectKey: "default",
    restrictedModelsRequest: {
      keys: [
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { aiConfigsAddRestrictedModels } from "@launchdarkly/mcp-server/funcs/aiConfigsAddRestrictedModels.js";
...
async function run() {
  const res = await aiConfigsAddRestrictedModels(launchDarkly, {
    ldAPIVersion: "beta",
    projectKey: "default",
    restrictedModelsRequest: {
      keys: [
...
**Promise\<[components.RestrictedModelsResponse](../../models/components/restrictedmodelsresponse.md)\>**
...
async function run() {
  const result = await launchDarkly.aiConfigs.listModels({
    ldAPIVersion: "beta",
    projectKey: "default",
  });
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { aiConfigsListModels } from "@launchdarkly/mcp-server/funcs/aiConfigsListModels.js";
...
async function run() {
  const res = await aiConfigsListModels(launchDarkly, {
    ldAPIVersion: "beta",
    projectKey: "default",
  });
...
**Promise\<[components.ModelConfig[]](../../models/.md)\>**
...
async function run() {
  const result = await launchDarkly.aiConfigs.createModelConfig({
    ldAPIVersion: "beta",
    projectKey: "default",
    modelConfigPost: {
      name: "name",
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { aiConfigsCreateModelConfig } from "@launchdarkly/mcp-server/funcs/aiConfigsCreateModelConfig.js";
...
async function run() {
  const res = await aiConfigsCreateModelConfig(launchDarkly, {
    ldAPIVersion: "beta",
    projectKey: "default",
    modelConfigPost: {
      name: "name",
...
**Promise\<[components.ModelConfig](../../models/components/modelconfig.md)\>**
...
async function run() {
  await launchDarkly.aiConfigs.deleteModelConfig({
    ldAPIVersion: "beta",
    projectKey: "default",
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { aiConfigsDeleteModelConfig } from "@launchdarkly/mcp-server/funcs/aiConfigsDeleteModelConfig.js";
...
async function run() {
  const res = await aiConfigsDeleteModelConfig(launchDarkly, {
    ldAPIVersion: "beta",
    projectKey: "default",
    modelConfigKey: "<value>",
  });
...
async function run() {
  const result = await launchDarkly.aiConfigs.getModelConfig({
    ldAPIVersion: "beta",
    projectKey: "default",
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { aiConfigsGetModelConfig } from "@launchdarkly/mcp-server/funcs/aiConfigsGetModelConfig.js";
...
async function run() {
  const res = await aiConfigsGetModelConfig(launchDarkly, {
    ldAPIVersion: "beta",
    projectKey: "default",
    modelConfigKey: "default",
  });
