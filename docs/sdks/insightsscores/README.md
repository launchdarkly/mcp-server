...
* [createGroup](#creategroup) - Create insight group
* [list](#list) - List insight groups
* [getGroup](#getgroup) - Get insight group
* [updateGroup](#updategroup) - Patch insight group
* [deleteGroup](#deletegroup) - Delete insight group
* [get](#get) - Get insight scores
...
async function run() {
  const result = await launchDarkly.insightsScores.createGroup({
...
import { insightsScoresCreateGroup } from "@launchdarkly/mcp-server/funcs/insightsScoresCreateGroup.js";
...
async function run() {
  const res = await insightsScoresCreateGroup(launchDarkly, {
    name: "Production - All Apps",
    key: "default-production-all-apps",
    projectKey: "default",
    environmentKey: "production",
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [components.PostInsightGroupParams](../../models/components/postinsightgroupparams.md)                                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[components.InsightGroup](../../models/components/insightgroup.md)\>**
...
async function run() {
  const result = await launchDarkly.insightsScores.list({});
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { insightsScoresList } from "@launchdarkly/mcp-server/funcs/insightsScoresList.js";
...
async function run() {
  const res = await insightsScoresList(launchDarkly, {});
...
**Promise\<[components.InsightGroupCollection](../../models/components/insightgroupcollection.md)\>**
...
async function run() {
  const result = await launchDarkly.insightsScores.getGroup({
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { insightsScoresGetGroup } from "@launchdarkly/mcp-server/funcs/insightsScoresGetGroup.js";
...
async function run() {
  const res = await insightsScoresGetGroup(launchDarkly, {
    insightGroupKey: "<value>",
  });
...
async function run() {
  const result = await launchDarkly.insightsScores.updateGroup({
    insightGroupKey: "<value>",
    requestBody: [
      {
        op: "replace",
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { insightsScoresUpdateGroup } from "@launchdarkly/mcp-server/funcs/insightsScoresUpdateGroup.js";
...
async function run() {
  const res = await insightsScoresUpdateGroup(launchDarkly, {
    insightGroupKey: "<value>",
    requestBody: [
      {
        op: "replace",
...
async function run() {
  await launchDarkly.insightsScores.deleteGroup({
    insightGroupKey: "<value>",
  });
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { insightsScoresDeleteGroup } from "@launchdarkly/mcp-server/funcs/insightsScoresDeleteGroup.js";
...
async function run() {
  const res = await insightsScoresDeleteGroup(launchDarkly, {
    insightGroupKey: "<value>",
  });
...
async function run() {
  const result = await launchDarkly.insightsScores.get({
    projectKey: "<value>",
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { insightsScoresGet } from "@launchdarkly/mcp-server/funcs/insightsScoresGet.js";
...
async function run() {
  const res = await insightsScoresGet(launchDarkly, {
    projectKey: "<value>",
    environmentKey: "<value>",
  });
...
**Promise\<[components.InsightScores](../../models/components/insightscores.md)\>**
