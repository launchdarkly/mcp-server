...
* [createDeploymentEvent](#createdeploymentevent) - Create deployment event
...
async function run() {
  await launchdarklyMcpServer.insightsDeploymentsBeta.createDeploymentEvent({
    projectKey: "default",
...
import { insightsDeploymentsBetaCreateDeploymentEvent } from "@launchdarkly/mcp-server/funcs/insightsDeploymentsBetaCreateDeploymentEvent.js";
...
async function run() {
  const res = await insightsDeploymentsBetaCreateDeploymentEvent(launchdarklyMcpServer, {
    projectKey: "default",
    environmentKey: "production",
    applicationKey: "billing-service",
    applicationName: "Billing Service",
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.PostDeploymentEventInput](../../models/postdeploymenteventinput.md)                                                                                                    | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
async function run() {
  const result = await launchdarklyMcpServer.insightsDeploymentsBeta.getDeployments({
    projectKey: "<value>",
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { insightsDeploymentsBetaGetDeployments } from "@launchdarkly/mcp-server/funcs/insightsDeploymentsBetaGetDeployments.js";
...
async function run() {
  const res = await insightsDeploymentsBetaGetDeployments(launchdarklyMcpServer, {
    projectKey: "<value>",
    environmentKey: "<value>",
  });
...
**Promise\<[models.DeploymentCollectionRep](../../models/deploymentcollectionrep.md)\>**
...
async function run() {
  const result = await launchdarklyMcpServer.insightsDeploymentsBeta.getDeployment({
    deploymentID: "<value>",
  });
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { insightsDeploymentsBetaGetDeployment } from "@launchdarkly/mcp-server/funcs/insightsDeploymentsBetaGetDeployment.js";
...
async function run() {
  const res = await insightsDeploymentsBetaGetDeployment(launchdarklyMcpServer, {
    deploymentID: "<value>",
  });
...
**Promise\<[models.DeploymentRep](../../models/deploymentrep.md)\>**
...
async function run() {
  const result = await launchdarklyMcpServer.insightsDeploymentsBeta.updateDeployment({
    deploymentID: "<value>",
    requestBody: [
      {
        op: "replace",
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { insightsDeploymentsBetaUpdateDeployment } from "@launchdarkly/mcp-server/funcs/insightsDeploymentsBetaUpdateDeployment.js";
...
async function run() {
  const res = await insightsDeploymentsBetaUpdateDeployment(launchdarklyMcpServer, {
    deploymentID: "<value>",
    requestBody: [
      {
        op: "replace",
