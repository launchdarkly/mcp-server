...
* [updateOverride](#updateoverride) - override flag value with value provided in the body
* [deleteOverride](#deleteoverride) - remove override for flag
...
async function run() {
  const result = await launchDarkly.devServer.updateOverride({
    projectKey: "<value>",
    flagKey: "<value>",
    flagValue: 6989.4,
  });
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { devServerUpdateOverride } from "@launchdarkly/mcp-server/funcs/devServerUpdateOverride.js";
...
async function run() {
  const res = await devServerUpdateOverride(launchDarkly, {
    projectKey: "<value>",
    flagKey: "<value>",
    flagValue: 6989.4,
  });
...
async function run() {
  await launchDarkly.devServer.deleteOverride({
    projectKey: "<value>",
    flagKey: "<value>",
  });
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { devServerDeleteOverride } from "@launchdarkly/mcp-server/funcs/devServerDeleteOverride.js";
...
async function run() {
  const res = await devServerDeleteOverride(launchDarkly, {
    projectKey: "<value>",
    flagKey: "<value>",
  });
