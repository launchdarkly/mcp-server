...
* [list](#list) - List flag links
* [create](#create) - Create flag link
* [update](#update) - Update flag link
* [delete](#delete) - Delete flag link
...
async function run() {
  const result = await launchDarkly.flagLinks.list({
    projectKey: "<value>",
...
import { flagLinksList } from "@launchdarkly/mcp-server/funcs/flagLinksList.js";
...
async function run() {
  const res = await flagLinksList(launchDarkly, {
    projectKey: "<value>",
    featureFlagKey: "<value>",
  });
...
**Promise\<[components.FlagLinkCollectionRep](../../models/components/flaglinkcollectionrep.md)\>**
...
async function run() {
  const result = await launchDarkly.flagLinks.create({
    projectKey: "<value>",
    featureFlagKey: "<value>",
    flagLinkPost: {
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { flagLinksCreate } from "@launchdarkly/mcp-server/funcs/flagLinksCreate.js";
...
async function run() {
  const res = await flagLinksCreate(launchDarkly, {
    projectKey: "<value>",
    featureFlagKey: "<value>",
    flagLinkPost: {
      key: "flag-link-key-123abc",
...
**Promise\<[components.FlagLinkRep](../../models/components/flaglinkrep.md)\>**
...
async function run() {
  const result = await launchDarkly.flagLinks.update({
    projectKey: "<value>",
    featureFlagKey: "<value>",
    id: "<value>",
    requestBody: [
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { flagLinksUpdate } from "@launchdarkly/mcp-server/funcs/flagLinksUpdate.js";
...
async function run() {
  const res = await flagLinksUpdate(launchDarkly, {
    projectKey: "<value>",
    featureFlagKey: "<value>",
    id: "<value>",
    requestBody: [
...
async function run() {
  await launchDarkly.flagLinks.delete({
    projectKey: "<value>",
    featureFlagKey: "<value>",
    id: "<value>",
  });
...
```typescript
import { LaunchDarklyCore } from "@launchdarkly/mcp-server/core.js";
import { flagLinksDelete } from "@launchdarkly/mcp-server/funcs/flagLinksDelete.js";
...
async function run() {
  const res = await flagLinksDelete(launchDarkly, {
    projectKey: "<value>",
    featureFlagKey: "<value>",
    id: "<value>",
  });
