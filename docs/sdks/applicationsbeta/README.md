...
* [getApplication](#getapplication) - Get application by key
* [deleteApplication](#deleteapplication) - Delete application
* [patchApplication](#patchapplication) - Update application
* [getApplicationVersions](#getapplicationversions) - Get application versions by application key
* [deleteApplicationVersion](#deleteapplicationversion) - Delete application version
* [patchApplicationVersion](#patchapplicationversion) - Update application version
...
async function run() {
  const result = await launchdarklyMcpServer.applicationsBeta.getApplications({});
...
import { applicationsBetaGetApplications } from "@launchdarkly/mcp-server/funcs/applicationsBetaGetApplications.js";
...
async function run() {
  const res = await applicationsBetaGetApplications(launchdarklyMcpServer, {});
...
**Promise\<[models.ApplicationCollectionRep](../../models/applicationcollectionrep.md)\>**
...
async function run() {
  const result = await launchdarklyMcpServer.applicationsBeta.getApplication({
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { applicationsBetaGetApplication } from "@launchdarkly/mcp-server/funcs/applicationsBetaGetApplication.js";
...
async function run() {
  const res = await applicationsBetaGetApplication(launchdarklyMcpServer, {
    applicationKey: "<value>",
  });
...
**Promise\<[models.ApplicationRep](../../models/applicationrep.md)\>**
...
async function run() {
  await launchdarklyMcpServer.applicationsBeta.deleteApplication({
    applicationKey: "<value>",
  });
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { applicationsBetaDeleteApplication } from "@launchdarkly/mcp-server/funcs/applicationsBetaDeleteApplication.js";
...
async function run() {
  const res = await applicationsBetaDeleteApplication(launchdarklyMcpServer, {
    applicationKey: "<value>",
  });
...
async function run() {
  const result = await launchdarklyMcpServer.applicationsBeta.patchApplication({
    applicationKey: "<value>",
    requestBody: [
      {
        op: "replace",
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { applicationsBetaPatchApplication } from "@launchdarkly/mcp-server/funcs/applicationsBetaPatchApplication.js";
...
async function run() {
  const res = await applicationsBetaPatchApplication(launchdarklyMcpServer, {
    applicationKey: "<value>",
    requestBody: [
      {
        op: "replace",
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PatchApplicationRequest](../../models/operations/patchapplicationrequest.md)                                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await launchdarklyMcpServer.applicationsBeta.getApplicationVersions({
    applicationKey: "<value>",
  });
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { applicationsBetaGetApplicationVersions } from "@launchdarkly/mcp-server/funcs/applicationsBetaGetApplicationVersions.js";
...
async function run() {
  const res = await applicationsBetaGetApplicationVersions(launchdarklyMcpServer, {
    applicationKey: "<value>",
  });
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetApplicationVersionsRequest](../../models/operations/getapplicationversionsrequest.md)                                                                           | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.ApplicationVersionsCollectionRep](../../models/applicationversionscollectionrep.md)\>**
...
async function run() {
  await launchdarklyMcpServer.applicationsBeta.deleteApplicationVersion({
    applicationKey: "<value>",
    versionKey: "<value>",
  });
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { applicationsBetaDeleteApplicationVersion } from "@launchdarkly/mcp-server/funcs/applicationsBetaDeleteApplicationVersion.js";
...
async function run() {
  const res = await applicationsBetaDeleteApplicationVersion(launchdarklyMcpServer, {
    applicationKey: "<value>",
    versionKey: "<value>",
  });
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.DeleteApplicationVersionRequest](../../models/operations/deleteapplicationversionrequest.md)                                                                       | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await launchdarklyMcpServer.applicationsBeta.patchApplicationVersion({
    applicationKey: "<value>",
    versionKey: "<value>",
    requestBody: [
      {
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { applicationsBetaPatchApplicationVersion } from "@launchdarkly/mcp-server/funcs/applicationsBetaPatchApplicationVersion.js";
...
async function run() {
  const res = await applicationsBetaPatchApplicationVersion(launchdarklyMcpServer, {
    applicationKey: "<value>",
    versionKey: "<value>",
    requestBody: [
      {
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.PatchApplicationVersionRequest](../../models/operations/patchapplicationversionrequest.md)                                                                         | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[models.ApplicationVersionRep](../../models/applicationversionrep.md)\>**
