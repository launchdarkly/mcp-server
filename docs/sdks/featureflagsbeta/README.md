...
* [getDependentFlagsByEnv](#getdependentflagsbyenv) - List dependent feature flags by environment
* [getDependentFlags](#getdependentflags) - List dependent feature flags
...
async function run() {
  const result = await launchdarklyMcpServer.featureFlagsBeta.getDependentFlagsByEnv({
    projectKey: "<value>",
...
import { featureFlagsBetaGetDependentFlagsByEnv } from "@launchdarkly/mcp-server/funcs/featureFlagsBetaGetDependentFlagsByEnv.js";
...
async function run() {
  const res = await featureFlagsBetaGetDependentFlagsByEnv(launchdarklyMcpServer, {
    projectKey: "<value>",
    environmentKey: "<value>",
    featureFlagKey: "<value>",
  });
...
**Promise\<[models.DependentFlagsByEnvironment](../../models/dependentflagsbyenvironment.md)\>**
...
async function run() {
  const result = await launchdarklyMcpServer.featureFlagsBeta.getDependentFlags({
    projectKey: "<value>",
    featureFlagKey: "<value>",
  });
...
```typescript
import { LaunchdarklyMcpServerCore } from "@launchdarkly/mcp-server/core.js";
import { featureFlagsBetaGetDependentFlags } from "@launchdarkly/mcp-server/funcs/featureFlagsBetaGetDependentFlags.js";
...
async function run() {
  const res = await featureFlagsBetaGetDependentFlags(launchdarklyMcpServer, {
    projectKey: "<value>",
    featureFlagKey: "<value>",
  });
...
**Promise\<[models.MultiEnvironmentDependentFlags](../../models/multienvironmentdependentflags.md)\>**
