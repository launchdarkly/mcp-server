...
```typescript
import { AiConfigsAccessDeniedReason } from "@launchdarkly/mcp-server/models/components";
...
| `effect`                                                                                                                                              | [components.AiConfigsAccessDeniedReasonEffect](../../models/components/aiconfigsaccessdeniedreasoneffect.md)                                          | :heavy_check_mark:                                                                                                                                    | Whether this statement should allow or deny actions on the resources.                                                                                 | allow                                                                                                                                                 |
