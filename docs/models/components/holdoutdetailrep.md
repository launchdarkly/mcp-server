...
```typescript
import { HoldoutDetailRep } from "@launchdarkly/mcp-server/models/components";
...
| `status`                                                                                   | [components.HoldoutDetailRepStatus](../../models/components/holdoutdetailrepstatus.md)     | :heavy_check_mark:                                                                         | N/A                                                                                        |
...
| `relatedExperiments`                                                                       | [components.Experiment](../../models/components/experiment.md)[]                           | :heavy_minus_sign:                                                                         | N/A                                                                                        |