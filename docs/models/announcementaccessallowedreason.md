...
```typescript
import { AnnouncementAccessAllowedReason } from "@launchdarkly/mcp-server";
...
| `effect`                                                                                                                                              | [models.AnnouncementAccessAllowedReasonEffect](../models/announcementaccessallowedreasoneffect.md)                                                    | :heavy_check_mark:                                                                                                                                    | Whether this statement should allow or deny actions on the resources.                                                                                 | allow                                                                                                                                                 |
