...
```typescript
import { AiConfigsAccessAllowedReason } from "@launchdarkly/mcp-server";
...
| `effect`                                                                                                                                              | [models.AiConfigsAccessAllowedReasonEffect](../models/aiconfigsaccessallowedreasoneffect.md)                                                          | :heavy_check_mark:                                                                                                                                    | Whether this statement should allow or deny actions on the resources.                                                                                 | allow                                                                                                                                                 |
