...
```typescript
import { AnnouncementAccessDeniedReason } from "@launchdarkly/mcp-server";
...
| `effect`                                                                                                                                              | [models.AnnouncementAccessDeniedReasonEffect](../models/announcementaccessdeniedreasoneffect.md)                                                      | :heavy_check_mark:                                                                                                                                    | Whether this statement should allow or deny actions on the resources.                                                                                 | allow                                                                                                                                                 |
