...
export class Layers extends ClientSDK {
  ...
  ): Promise<components.LayerCollectionRep> {
    return unwrapAsync(layersList(
      this,
      request,
      options,
    ));
  ...
  async create(
    ...
    options?: RequestOptions,
  ): Promise<components.LayerRep> {
    return unwrapAsync(layersCreate(
      this,
      request,
      options,
    ));
  ...
  async update(
    ...
    return unwrapAsync(layersUpdate(
      this,
      request,
      options,
    ));
