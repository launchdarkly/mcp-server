...
import { teamsAddMembers } from "../funcs/teamsAddMembers.js";
...
import { teamsGetMaintainers } from "../funcs/teamsGetMaintainers.js";
import { teamsGetRoles } from "../funcs/teamsGetRoles.js";
import { teamsList } from "../funcs/teamsList.js";
import { teamsPatch } from "../funcs/teamsPatch.js";
...
export class Teams extends ClientSDK {
  ...
  async getMaintainers(
    ...
    options?: RequestOptions,
  ): Promise<components.TeamMaintainers> {
    return unwrapAsync(teamsGetMaintainers(
      this,
      request,
      options,
    ));
  ...
  async addMembers(
    ...
    options?: RequestOptions,
  ): Promise<components.TeamImportsRep> {
    return unwrapAsync(teamsAddMembers(
      this,
      request,
      options,
    ));
  ...
  async getRoles(
    ...
    options?: RequestOptions,
  ): Promise<components.TeamCustomRoles> {
   ...
   */
  async update(
    request: components.TeamsPatchInput,
    options?: RequestOptions,
  ): Promise<components.BulkEditTeamsRep> {
