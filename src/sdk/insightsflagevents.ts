...
import { insightsFlagEventsList } from "../funcs/insightsFlagEventsList.js";
import { ClientSDK, RequestOptions } from "../lib/sdks.js";
import * as components from "../models/components/index.js";
import * as operations from "../models/operations/index.js";
import { unwrapAsync } from "../types/fp.js";

export class InsightsFlagEvents extends ClientSDK {
  /**
   * List flag events
   *
   * @remarks
  ...
  ): Promise<components.FlagEventCollectionRep> {
    return unwrapAsync(insightsFlagEventsList(
      this,
      request,
      options,
    ));
