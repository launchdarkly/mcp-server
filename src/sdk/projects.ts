...
import { projectsGetFlagDefaults } from "../funcs/projectsGetFlagDefaults.js";
import { projectsList } from "../funcs/projectsList.js";
import { projectsPatchFlagDefaults } from "../funcs/projectsPatchFlagDefaults.js";
import { projectsSetFlagDefaults } from "../funcs/projectsSetFlagDefaults.js";
...
export class Projects extends ClientSDK {
   ...
   */
  async create(
    request: components.ProjectPost,
    options?: RequestOptions,
  ): Promise<components.ProjectRep> {
   ...
   */
  async getFlagDefaults(
    request: operations.GetFlagDefaultsByProjectRequest,
    options?: RequestOptions,
  ): Promise<components.FlagDefaultsRep> {
    return unwrapAsync(projectsGetFlagDefaults(
      this,
      request,
      options,
    ));
   ...
   */
  async patchFlagDefaults(
    request: operations.PatchFlagDefaultsByProjectRequest,
    options?: RequestOptions,
  ): Promise<components.UpsertPayloadRep> {
    return unwrapAsync(projectsPatchFlagDefaults(
      this,
      request,
      options,
    ));
   ...
   */
  async setFlagDefaults(
    request: operations.PutFlagDefaultsByProjectRequest,
    options?: RequestOptions,
  ): Promise<components.UpsertPayloadRep> {
    return unwrapAsync(projectsSetFlagDefaults(
      this,
      request,
      options,
    ));
