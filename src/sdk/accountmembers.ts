...
export class AccountMembers extends ClientSDK {
  ...
  ): Promise<models.Members> {
    return unwrapAsync(accountMembersGetMembers(
      this,
      request,
      options,
    ));
   ...
   */
  async postMembers(
    request: Array<models.NewMemberForm>,
    options?: RequestOptions,
  ): Promise<models.Members> {
    return unwrapAsync(accountMembersPostMembers(
      this,
      request,
      options,
    ));
  ...
  async getMember(
    ...
    return unwrapAsync(accountMembersGetMember(
      this,
      request,
      options,
    ));
  ...
  async deleteMember(
    ...
    return unwrapAsync(accountMembersDeleteMember(
      this,
      request,
      options,
    ));
  ...
  async patchMember(
    ...
    return unwrapAsync(accountMembersPatchMember(
      this,
      request,
      options,
    ));
   ...
   */
  async postMemberTeams(
    request: operations.PostMemberTeamsRequest,
    options?: RequestOptions,
  ): Promise<models.Member> {
    return unwrapAsync(accountMembersPostMemberTeams(
      this,
      request,
      options,
    ));
