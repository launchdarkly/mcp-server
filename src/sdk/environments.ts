...
import { environmentsPatch } from "../funcs/environmentsPatch.js";
import { environmentsResetMobileKey } from "../funcs/environmentsResetMobileKey.js";
import { environmentsResetSDKKey } from "../funcs/environmentsResetSDKKey.js";
...
export class Environments extends ClientSDK {
  ...
  async patch(
    ...
    return unwrapAsync(environmentsPatch(
      this,
      request,
      options,
    ));
  ...
  async resetSDKKey(
    ...
    return unwrapAsync(environmentsResetSDKKey(
      this,
      request,
      options,
    ));
   ...
   */
  async resetMobileKey(
    request: operations.ResetEnvironmentMobileKeyRequest,
    options?: RequestOptions,
  ): Promise<components.Environment> {
    return unwrapAsync(environmentsResetMobileKey(
      this,
      request,
      options,
    ));
