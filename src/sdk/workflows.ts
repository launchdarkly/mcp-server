...
import { workflowsPostWorkflow } from "../funcs/workflowsPostWorkflow.js";
...
export class Workflows extends ClientSDK {
  ...
  ): Promise<models.CustomWorkflowsListingOutput> {
    return unwrapAsync(workflowsGetWorkflows(
      this,
      request,
      options,
    ));
  ...
  async postWorkflow(
    ...
    options?: RequestOptions,
  ): Promise<models.CustomWorkflowOutput> {
    return unwrapAsync(workflowsPostWorkflow(
      this,
      request,
      options,
    ));
   ...
   */
  async getCustomWorkflow(
    request: operations.GetCustomWorkflowRequest,
    options?: RequestOptions,
  ): Promise<models.CustomWorkflowOutput> {
    return unwrapAsync(workflowsGetCustomWorkflow(
      this,
      request,
      options,
    ));
  ...
  async deleteWorkflow(
    ...
    return unwrapAsync(workflowsDeleteWorkflow(
      this,
      request,
      options,
    ));
