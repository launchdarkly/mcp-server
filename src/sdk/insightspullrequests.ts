...
import { insightsPullRequestsList } from "../funcs/insightsPullRequestsList.js";
import { ClientSDK, RequestOptions } from "../lib/sdks.js";
import * as components from "../models/components/index.js";
import * as operations from "../models/operations/index.js";
import { unwrapAsync } from "../types/fp.js";

export class InsightsPullRequests extends ClientSDK {
  /**
   * List pull requests
   *
   * @remarks
  ...
  ): Promise<components.PullRequestCollectionRep> {
    return unwrapAsync(insightsPullRequestsList(
      this,
      request,
      options,
    ));
