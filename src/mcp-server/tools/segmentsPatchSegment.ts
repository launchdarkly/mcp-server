...
const args = {
  request: operations.PatchSegmentRequest$inboundSchema,
};

export const tool$segmentsPatchSegment: ToolDefinition<typeof args> = {
  name: "segments-patch-segment",
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await segmentsPatchSegment(
      client,
      args.request,
