...
export const tool$aiConfigsBetaPatchAIConfigVariation: ToolDefinition<
  typeof args
> = {
  name: "AI-configs-(beta)-patch-AI-config-variation",
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await aiConfigsBetaPatchAIConfigVariation(
      client,
      args.request,
