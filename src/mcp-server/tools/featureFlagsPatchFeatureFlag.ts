...
export const tool$featureFlagsPatchFeatureFlag: ToolDefinition<typeof args> = {
  name: "feature-flags-patch-feature-flag",
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await featureFlagsPatchFeatureFlag(
      client,
      args.request,
