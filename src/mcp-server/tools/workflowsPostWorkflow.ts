...
const args = {
  request: operations.PostWorkflowRequest$inboundSchema,
};

export const tool$workflowsPostWorkflow: ToolDefinition<typeof args> = {
  name: "workflows-post-workflow",
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await workflowsPostWorkflow(
      client,
      args.request,
