...
import { accountMembersBetaPatchMembers } from "../../funcs/accountMembersBetaPatchMembers.js";
import * as models from "../../models/index.js";
import { formatResult, ToolDefinition } from "../tools.js";

const args = {
  request: models.MembersPatchInput$inboundSchema,
};

export const tool$accountMembersBetaPatchMembers: ToolDefinition<typeof args> =
  {
    name: "account-members-(beta)-patch-members",
...
`,
    ...
    tool: async (client, args, ctx) => {
      const [result, apiCall] = await accountMembersBetaPatchMembers(
        client,
        args.request,
