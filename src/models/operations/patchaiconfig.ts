...
export type PatchAIConfigRequest = {
   ...
   */
  aiConfigPatch?: models.AIConfigPatch | undefined;
};
...
> = z.object({
  ...
  projectKey: z.string(),
  configKey: z.string(),
  AIConfigPatch: models.AIConfigPatch$inboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
...
export type PatchAIConfigRequest$Outbound = {
  ...
  projectKey: string;
  configKey: string;
  AIConfigPatch?: models.AIConfigPatch$Outbound | undefined;
};
...
> = z.object({
  ...
  projectKey: z.string(),
  configKey: z.string(),
  aiConfigPatch: models.AIConfigPatch$outboundSchema.optional(),
}).transform((v) => {
  return remap$(v, {
