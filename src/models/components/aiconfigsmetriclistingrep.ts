...
export type AiConfigsMetricListingRep = {
   ...
   */
  releasePolicyCount?: number | undefined;
  /**
...
> = z.object({
  ...
  releasePolicyCount: z.number().int().optional(),
  ...
  dataSource: AiConfigsMetricDataSourceRefRep$inboundSchema,
...
export type AiConfigsMetricListingRep$Outbound = {
  ...
  dataSource: AiConfigsMetricDataSourceRefRep$Outbound;
  lastSeen?: number | undefined;
  archived?: boolean | undefined;
  archivedAt?: number | undefined;
  selector?: string | undefined;
...
> = z.object({
  ...
  dataSource: AiConfigsMetricDataSourceRefRep$outboundSchema,
  lastSeen: z.number().int().optional(),
  archived: z.boolean().optional(),
  archivedAt: z.number().int().optional(),
  selector: z.string().optional(),
