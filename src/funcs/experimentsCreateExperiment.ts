 ...
 */
export function experimentsCreateExperiment(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateExperimentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ExperimentPost, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.Experiment$inboundSchema),
