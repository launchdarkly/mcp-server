 ...
 * Get delivery configuration by ID.
 */
export function integrationDeliveryConfigurationsBetaGetIntegrationDeliveryConfigurationById(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetIntegrationDeliveryConfigurationByIdRequest$outboundSchema
        .parse(value),
