...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetExperimentResultsForMetricGroupRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    ...
    metricGroupKey: encodeSimple("metricGroupKey", payload.metricGroupKey, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.MetricGroupResultsRep$inboundSchema),
