 ...
 */
export function layersCreateLayer(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateLayerRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.LayerPost, { explode: true });
  ...
  const path = pathToFunc("/api/v2/projects/{projectKey}/layers")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.LayerRep$inboundSchema),
