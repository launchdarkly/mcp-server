 ...
 */
export function accountUsageGetMauByCategory(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMauUsageByCategoryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/usage/mau/bycategory")();
