 ...
 */
export function scheduledChangesDeleteFlagConfigScheduledChanges(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteFlagConfigScheduledChangesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "403", "404", "405", "409", "429", "4XX", "5XX"],
