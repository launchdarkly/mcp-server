...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.EvaluateContextInstanceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ContextInstanceEvaluations$inboundSchema),
