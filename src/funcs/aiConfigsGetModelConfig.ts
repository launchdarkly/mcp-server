 ...
 */
export function aiConfigsGetModelConfig(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetModelConfigRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    modelConfigKey: encodeSimple("modelConfigKey", payload.modelConfigKey, {
      explode: false,
