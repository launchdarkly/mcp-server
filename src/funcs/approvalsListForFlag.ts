 ...
 */
export function approvalsListForFlag(
  client: LaunchDarklyCore,
  request: operations.GetApprovalsForFlagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.FlagConfigApprovalRequestsResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FlagConfigApprovalRequestsResponse$inboundSchema),
