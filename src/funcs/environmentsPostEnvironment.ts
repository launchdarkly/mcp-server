 ...
 */
export function environmentsPostEnvironment(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostEnvironmentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.EnvironmentPost, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.Environment$inboundSchema),
