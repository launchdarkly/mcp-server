 ...
 */
export function approvalsPostApprovalRequest(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateApprovalRequestRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.ApprovalRequestResponse$inboundSchema),
