...
import { DeleteAIConfigServerList } from "../models/operations/deleteaiconfig.js";
 ...
 */
export function aiConfigsDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteAIConfigRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteAIConfigServerList[0], { charEncoding: "percent" })();
