...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCustomWorkflowRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CustomWorkflowOutput$inboundSchema),
