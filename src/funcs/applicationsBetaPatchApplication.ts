...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchApplicationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/applications/{applicationKey}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ApplicationRep$inboundSchema),
