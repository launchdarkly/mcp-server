...
import { DeleteFeatureFlagServerList } from "../models/operations/deletefeatureflag.js";
 ...
 */
export function featureFlagsDelete(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteFeatureFlagRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(DeleteFeatureFlagServerList[0], {
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "404", "409", "429", "4XX", "5XX"],
