 ...
 */
export function dataExportDestinationsPostGenerateWarehouseDestinationKeyPair(
  client: LaunchdarklyMcpServerCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.GenerateWarehouseDestinationKeyPairPostRep,
...
> {
  ...
  >(
    M.json(
      201,
      models.GenerateWarehouseDestinationKeyPairPostRep$inboundSchema,
    ),
