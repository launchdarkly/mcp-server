 ...
 */
export function integrationsBetaGetAllIntegrationConfigurations(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetAllIntegrationConfigurationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.IntegrationConfigurationCollectionRep,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllIntegrationConfigurationsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.IntegrationConfigurationCollectionRep$inboundSchema),
