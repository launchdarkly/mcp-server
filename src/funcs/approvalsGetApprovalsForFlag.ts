 ...
 */
export function approvalsGetApprovalsForFlag(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetApprovalsForFlagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FlagConfigApprovalRequestsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetApprovalsForFlagRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagConfigApprovalRequestsResponse$inboundSchema),
