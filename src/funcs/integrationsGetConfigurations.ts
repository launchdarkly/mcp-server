 ...
 */
export function integrationsGetConfigurations(
  client: LaunchDarklyCore,
  request: operations.GetAllIntegrationConfigurationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationConfigurationCollectionRep,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.IntegrationConfigurationCollectionRep$inboundSchema),
