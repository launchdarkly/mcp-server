 ...
 */
export function workflowTemplatesCreateWorkflowTemplate(
  client: LaunchdarklyMcpServerCore,
  request: models.CreateWorkflowTemplateInput,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.WorkflowTemplateOutput,
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateWorkflowTemplateInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.WorkflowTemplateOutput$inboundSchema),
