...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateFlagLinkRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.flagLinkPost, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.FlagLinkRep$inboundSchema),
