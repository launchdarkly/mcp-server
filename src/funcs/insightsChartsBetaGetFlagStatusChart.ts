 ...
 */
export function insightsChartsBetaGetFlagStatusChart(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFlagStatusChartRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/charts/flags/status")();
