 ...
 */
export function accountMembersDeleteMember(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteMemberRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/members/{id}")(pathParams);
