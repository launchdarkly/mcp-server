...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAIConfigMetricsByVariationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(models.MetricByVariation$inboundSchema)),
