 ...
 */
export function workflowTemplatesGetWorkflowTemplates(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetWorkflowTemplatesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.WorkflowTemplatesListingOutputRep,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetWorkflowTemplatesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/templates")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.WorkflowTemplatesListingOutputRep$inboundSchema),
