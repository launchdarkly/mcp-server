 ...
 * Remove repository project association
 */
export function insightsRepositoriesBetaDeleteRepositoryProject(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteRepositoryProjectRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    repositoryKey: encodeSimple("repositoryKey", payload.repositoryKey, {
      explode: false,
      charEncoding: "percent",
    }),
  };
