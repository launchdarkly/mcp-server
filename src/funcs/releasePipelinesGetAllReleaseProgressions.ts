 ...
 */
export function releasePipelinesGetAllReleaseProgressions(
  client: LaunchDarklyCore,
  request: operations.GetAllReleaseProgressionsForReleasePipelineRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ReleaseProgressionCollection,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ReleaseProgressionCollection$inboundSchema),
