 ...
 */
export function accountUsageGetServiceConnectionUsage(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetServiceConnectionUsageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/usage/service-connections")();
