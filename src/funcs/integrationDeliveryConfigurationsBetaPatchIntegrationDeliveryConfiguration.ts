 ...
 */
export function integrationDeliveryConfigurationsBetaPatchIntegrationDeliveryConfiguration(
  client: LaunchdarklyMcpServerCore,
  request: operations.PatchIntegrationDeliveryConfigurationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.IntegrationDeliveryConfiguration,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchIntegrationDeliveryConfigurationRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.IntegrationDeliveryConfiguration$inboundSchema),
