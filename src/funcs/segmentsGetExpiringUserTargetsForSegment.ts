...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetExpiringUserTargetsForSegmentRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ExpiringUserTargetGetResponse$inboundSchema),
