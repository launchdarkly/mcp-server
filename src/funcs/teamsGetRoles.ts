...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetTeamRolesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/teams/{teamKey}/roles")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TeamCustomRoles$inboundSchema),
