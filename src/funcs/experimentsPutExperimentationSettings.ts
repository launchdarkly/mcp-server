...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutExperimentationSettingsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.RandomizationSettingsPut, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.RandomizationSettingsRep$inboundSchema),
