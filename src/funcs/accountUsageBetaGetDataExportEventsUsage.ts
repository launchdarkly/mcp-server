 ...
 */
export function accountUsageBetaGetDataExportEventsUsage(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDataExportEventsUsageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/usage/data-export-events")();
