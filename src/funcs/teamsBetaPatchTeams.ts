...
> {
  const parsed = safeParse(
    request,
    (value) => models.TeamsPatchInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.BulkEditTeamsRep$inboundSchema),
