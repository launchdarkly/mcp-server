 ...
 * Get context attribute names.
 */
export function contextsGetContextAttributeNames(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetContextAttributeNamesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ContextAttributeNamesCollection,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetContextAttributeNamesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ContextAttributeNamesCollection$inboundSchema),
