...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutFlagDefaultsByProjectRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpsertFlagDefaultsPayload, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v2/projects/{projectKey}/flag-defaults")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.UpsertPayloadRep$inboundSchema),
