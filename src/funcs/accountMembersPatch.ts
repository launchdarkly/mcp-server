 ...
 * </details>
 */
export function accountMembersPatch(
  client: LaunchDarklyCore,
  request: components.MembersPatchInput,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.BulkEditMembersRep,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.MembersPatchInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.BulkEditMembersRep$inboundSchema),
