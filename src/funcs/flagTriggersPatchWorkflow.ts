...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchTriggerWorkflowRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.FlagTriggerInput, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TriggerWorkflowRep$inboundSchema),
