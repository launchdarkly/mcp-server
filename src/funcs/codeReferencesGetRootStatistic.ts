 ...
 */
export function codeReferencesGetRootStatistic(
  client: LaunchdarklyMcpServerCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.StatisticsRoot,
...
> {
  const path = pathToFunc("/api/v2/code-refs/statistics")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.StatisticsRoot$inboundSchema),
