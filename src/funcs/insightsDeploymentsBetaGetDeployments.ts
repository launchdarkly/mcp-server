 ...
 */
export function insightsDeploymentsBetaGetDeployments(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetDeploymentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.DeploymentCollectionRep,
...
> {
  ...
  const path = pathToFunc("/api/v2/engineering-insights/deployments")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.DeploymentCollectionRep$inboundSchema),
