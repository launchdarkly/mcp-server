 ...
 * Associate repositories with projects
 */
export function insightsRepositoriesBetaAssociateRepositoriesAndProjects(
  client: LaunchdarklyMcpServerCore,
  request: models.InsightsRepositoryProjectMappings,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.InsightsRepositoryProjectCollection,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      models.InsightsRepositoryProjectMappings$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.InsightsRepositoryProjectCollection$inboundSchema),
