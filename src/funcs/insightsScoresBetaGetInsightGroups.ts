 ...
 */
export function insightsScoresBetaGetInsightGroups(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetInsightGroupsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.InsightGroupCollection,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetInsightGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/insights/groups")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.InsightGroupCollection$inboundSchema),
