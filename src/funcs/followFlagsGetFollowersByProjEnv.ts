 ...
 */
export function followFlagsGetFollowersByProjEnv(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetFollowersByProjEnvRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FlagFollowersByProjEnvGetRep,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetFollowersByProjEnvRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagFollowersByProjEnvGetRep$inboundSchema),
