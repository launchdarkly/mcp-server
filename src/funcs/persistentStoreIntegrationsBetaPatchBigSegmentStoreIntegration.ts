 ...
 */
export function persistentStoreIntegrationsBetaPatchBigSegmentStoreIntegration(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchBigSegmentStoreIntegrationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.BigSegmentStoreIntegration$inboundSchema),
