 ...
 */
export function integrationDeliveryConfigurationsBetaValidateIntegrationDeliveryConfiguration(
  client: LaunchdarklyMcpServerCore,
  request: operations.ValidateIntegrationDeliveryConfigurationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.IntegrationDeliveryConfigurationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ValidateIntegrationDeliveryConfigurationRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.IntegrationDeliveryConfigurationResponse$inboundSchema),
