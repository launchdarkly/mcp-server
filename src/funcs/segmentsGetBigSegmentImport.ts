 ...
 */
export function segmentsGetBigSegmentImport(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetBigSegmentImportRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    importID: encodeSimple("importID", payload.importID, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "404", "429", "4XX", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.Import$inboundSchema),
