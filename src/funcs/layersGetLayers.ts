...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetLayersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.LayerCollectionRep$inboundSchema),
