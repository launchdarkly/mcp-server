 ...
 */
export function insightsRepositoriesBetaGetInsightsRepositories(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetInsightsRepositoriesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.InsightsRepositoryCollection,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInsightsRepositoriesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/repositories")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.InsightsRepositoryCollection$inboundSchema),
