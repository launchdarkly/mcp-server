 ...
 */
export function flagTriggersGetTriggerWorkflows(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetTriggerWorkflowsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.TriggerWorkflowCollectionRep,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTriggerWorkflowsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.TriggerWorkflowCollectionRep$inboundSchema),
