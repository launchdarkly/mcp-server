...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetFeatureFlagStatusRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagStatusRep$inboundSchema),
