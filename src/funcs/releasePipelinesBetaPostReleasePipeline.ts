...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostReleasePipelineRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateReleasePipelineInput, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v2/projects/{projectKey}/release-pipelines")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.ReleasePipeline$inboundSchema),
