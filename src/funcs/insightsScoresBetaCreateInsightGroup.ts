 ...
 * Create insight group
 */
export function insightsScoresBetaCreateInsightGroup(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.PostInsightGroupParams$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.InsightGroup$inboundSchema),
