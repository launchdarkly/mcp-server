 ...
 * List all delivery configurations.
 */
export function integrationDeliveryConfigurationsBetaGetIntegrationDeliveryConfigurations(
...
> {
  const path = pathToFunc("/api/v2/integration-capabilities/featureStore")();
