...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SearchContextInstancesRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ContextInstanceSearch, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ContextInstances$inboundSchema),
