 ...
 */
export function releasePipelinesBetaGetAllReleaseProgressionsForReleasePipeline(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetAllReleaseProgressionsForReleasePipelineRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ReleaseProgressionCollection,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ReleaseProgressionCollection$inboundSchema),
