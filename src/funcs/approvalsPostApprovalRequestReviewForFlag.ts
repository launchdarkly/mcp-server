 ...
 */
export function approvalsPostApprovalRequestReviewForFlag(
  client: LaunchdarklyMcpServerCore,
  request: operations.PostApprovalRequestReviewForFlagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FlagConfigApprovalRequestResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApprovalRequestReviewForFlagRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagConfigApprovalRequestResponse$inboundSchema),
