 ...
 */
export function integrationDeliveryConfigurationsUpdate(
  client: LaunchDarklyCore,
  request: operations.PatchIntegrationDeliveryConfigurationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationDeliveryConfiguration,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.IntegrationDeliveryConfiguration$inboundSchema),
