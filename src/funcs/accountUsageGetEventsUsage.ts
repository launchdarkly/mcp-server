 ...
 */
export function accountUsageGetEventsUsage(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetEventsUsageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/usage/events/{type}")(pathParams);
