 ...
 */
export function otherGetCallerIdentity(
  client: LaunchDarklyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.CallerIdentityRep,
...
> {
  const path = pathToFunc("/api/v2/caller-identity")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CallerIdentityRep$inboundSchema),
