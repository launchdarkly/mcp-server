...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetInsightsScoresRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/insights/scores")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.InsightScores$inboundSchema),
