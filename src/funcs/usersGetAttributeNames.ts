...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetUserAttributeNamesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.UserAttributeNamesRep$inboundSchema),
