 ...
 * Get context attribute values.
 */
export function contextsGetContextAttributeValues(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetContextAttributeValuesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ContextAttributeValuesCollection,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ContextAttributeValuesCollection$inboundSchema),
