 ...
 */
export function approvalsCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.CreateApprovalRequestRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.ApprovalRequestResponse$inboundSchema),
