 ...
 */
export function insightsFlagEventsBetaGetFlagEvents(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetFlagEventsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FlagEventCollectionRep,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFlagEventsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/flag-events")();
  ...
  const query = encodeFormQuery({
    ...
    "hasExperiments": payload.hasExperiments,
    "impactSize": payload.impactSize,
    "limit": payload.limit,
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagEventCollectionRep$inboundSchema),
