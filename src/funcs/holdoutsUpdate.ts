...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchHoldoutRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.HoldoutPatchInput, { explode: true });
  ...
  const pathParams = {
    ...
    holdoutKey: encodeSimple("holdoutKey", payload.holdoutKey, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.HoldoutRep$inboundSchema),
