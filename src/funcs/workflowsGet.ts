...
export function workflowsGet(
  ...
  Result<
    components.CustomWorkflowsListingOutput,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetWorkflowsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CustomWorkflowsListingOutput$inboundSchema),
