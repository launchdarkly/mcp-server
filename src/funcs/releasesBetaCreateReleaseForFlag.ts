 ...
 */
export function releasesBetaCreateReleaseForFlag(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateReleaseForFlagRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateReleaseInput, {
    explode: true,
  });
