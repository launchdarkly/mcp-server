 ...
 */
export function featureFlagsBetaGetDependentFlagsByEnv(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetDependentFlagsByEnvRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.DependentFlagsByEnvironment,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDependentFlagsByEnvRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.DependentFlagsByEnvironment$inboundSchema),
