 ...
 */
export function accountMembersPostMemberTeams(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostMemberTeamsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.MemberTeamsPostInput, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v2/members/{id}/teams")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.Member$inboundSchema),
