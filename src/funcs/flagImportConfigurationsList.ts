 ...
 * List all flag import configurations.
 */
export function flagImportConfigurationsList(
  client: LaunchDarklyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.FlagImportIntegrationCollection,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FlagImportIntegrationCollection$inboundSchema),
