...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchApplicationVersionRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    versionKey: encodeSimple("versionKey", payload.versionKey, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ApplicationVersionRep$inboundSchema),
