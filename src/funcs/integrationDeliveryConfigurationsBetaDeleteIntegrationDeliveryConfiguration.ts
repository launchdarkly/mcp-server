 ...
 */
export function integrationDeliveryConfigurationsBetaDeleteIntegrationDeliveryConfiguration(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteIntegrationDeliveryConfigurationRequest$outboundSchema
        .parse(value),
