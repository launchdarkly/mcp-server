...
import { GetAIConfigsServerList } from "../models/operations/getaiconfigs.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAIConfigsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAIConfigsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.AIConfigs$inboundSchema),
