 ...
 */
export function releasePipelinesBetaGetAllReleasePipelines(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetAllReleasePipelinesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ReleasePipelineCollection,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllReleasePipelinesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ReleasePipelineCollection$inboundSchema),
