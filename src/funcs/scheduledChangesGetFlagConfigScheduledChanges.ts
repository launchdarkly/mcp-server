 ...
 */
export function scheduledChangesGetFlagConfigScheduledChanges(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetFlagConfigScheduledChangesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FeatureFlagScheduledChanges,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetFlagConfigScheduledChangesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FeatureFlagScheduledChanges$inboundSchema),
