 ...
 */
export function customRolesPostCustomRole(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CustomRolePost$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/roles")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.CustomRole$inboundSchema),
