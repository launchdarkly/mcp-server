 ...
 */
export function applicationsBetaGetApplications(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetApplicationsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ApplicationCollectionRep,
...
> {
  ...
  const path = pathToFunc("/api/v2/applications")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ApplicationCollectionRep$inboundSchema),
