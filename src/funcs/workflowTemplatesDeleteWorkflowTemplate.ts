 ...
 */
export function workflowTemplatesDeleteWorkflowTemplate(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteWorkflowTemplateRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    templateKey: encodeSimple("templateKey", payload.templateKey, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/api/v2/templates/{templateKey}")(pathParams);
