 ...
 * Create deployment event
 */
export function insightsDeploymentsBetaCreateDeploymentEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.PostDeploymentEventInput$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/deployment-events")();
