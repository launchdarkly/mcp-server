 ...
 */
export function aiConfigsBetaGetAIConfigMetrics(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAIConfigMetricsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.Metrics$inboundSchema),
