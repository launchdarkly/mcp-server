 ...
 * Associate repositories with projects
 */
export function insightsRepositoriesAssociate(
  client: LaunchDarklyCore,
  request: components.InsightsRepositoryProjectMappings,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.InsightsRepositoryProjectCollection,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.InsightsRepositoryProjectMappings$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.InsightsRepositoryProjectCollection$inboundSchema),
