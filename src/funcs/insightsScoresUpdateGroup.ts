...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchInsightGroupRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    insightGroupKey: encodeSimple("insightGroupKey", payload.insightGroupKey, {
      explode: false,
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "403", "404", "422", "429", "4XX", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.InsightGroup$inboundSchema),
    ...
    M.jsonErr(422, errors.PatchFailedErrorRep$inboundSchema),
