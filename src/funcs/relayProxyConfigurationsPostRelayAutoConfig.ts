 ...
 */
export function relayProxyConfigurationsPostRelayAutoConfig(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.RelayAutoConfigPost$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.RelayAutoConfigRep$inboundSchema),
