...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetContextKindsByProjectKeyRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/projects/{projectKey}/context-kinds")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ContextKindsCollectionRep$inboundSchema),
