 ...
 */
export function featureFlagsGetFeatureFlagStatusAcrossEnvironments(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetFeatureFlagStatusAcrossEnvironmentsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FeatureFlagStatusAcrossEnvironments,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FeatureFlagStatusAcrossEnvironments$inboundSchema),
