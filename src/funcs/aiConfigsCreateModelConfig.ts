 ...
 */
export function aiConfigsCreateModelConfig(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostModelConfigRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ModelConfigPost, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ModelConfig$inboundSchema),
