 ...
 * Get Holdout by Id
 */
export function holdoutsGetById(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetHoldoutByIdRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    holdoutId: encodeSimple("holdoutId", payload.holdoutId, {
      explode: false,
      charEncoding: "percent",
    }),
