...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchRepositoryRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/code-refs/repositories/{repo}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.RepositoryRep$inboundSchema),
