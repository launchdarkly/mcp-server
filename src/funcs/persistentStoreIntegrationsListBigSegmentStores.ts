 ...
 * List all big segment store integrations.
 */
export function persistentStoreIntegrationsListBigSegmentStores(
  client: LaunchDarklyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.BigSegmentStoreIntegrationCollection,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.BigSegmentStoreIntegrationCollection$inboundSchema),
