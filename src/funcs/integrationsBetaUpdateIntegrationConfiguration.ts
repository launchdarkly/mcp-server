 ...
 */
export function integrationsBetaUpdateIntegrationConfiguration(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateIntegrationConfigurationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.IntegrationConfigurationsRep$inboundSchema),
