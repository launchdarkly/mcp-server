...
> {
  ...
  const path = pathToFunc("/api/v2/tags")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.TagsCollection$inboundSchema),
    M.jsonErr([400, 401, 403, 429], errors.ErrorT$inboundSchema),
