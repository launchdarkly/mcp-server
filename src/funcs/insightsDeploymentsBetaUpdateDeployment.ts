...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateDeploymentRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.DeploymentRep$inboundSchema),
