 ...
 * List all big segment store integrations.
 */
export function persistentStoreIntegrationsBetaGetBigSegmentStoreIntegrations(
  client: LaunchdarklyMcpServerCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.BigSegmentStoreIntegrationCollection,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.BigSegmentStoreIntegrationCollection$inboundSchema),
