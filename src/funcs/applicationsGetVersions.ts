 ...
 */
export function applicationsGetVersions(
  client: LaunchDarklyCore,
  request: operations.GetApplicationVersionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ApplicationVersionsCollectionRep,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ApplicationVersionsCollectionRep$inboundSchema),
