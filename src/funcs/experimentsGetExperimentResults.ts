 ...
 */
export function experimentsGetExperimentResults(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetExperimentResultsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ExperimentBayesianResultsRep,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetExperimentResultsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ExperimentBayesianResultsRep$inboundSchema),
