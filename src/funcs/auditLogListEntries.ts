 ...
 */
export function auditLogListEntries(
  client: LaunchDarklyCore,
  request: operations.GetAuditLogEntriesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AuditLogEntryListingRepCollection,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAuditLogEntriesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.AuditLogEntryListingRepCollection$inboundSchema),
