 ...
 */
export function segmentsGetExpiringUserTargets(
  client: LaunchDarklyCore,
  request: operations.GetExpiringUserTargetsForSegmentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ExpiringUserTargetGetResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ExpiringUserTargetGetResponse$inboundSchema),
