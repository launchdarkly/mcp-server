 ...
 * Create an announcement
 */
export function announcementsCreateAnnouncementPublic(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateAnnouncementBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.AnnouncementResponse$inboundSchema),
