...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetUserFlagSettingRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.UserFlagSetting$inboundSchema),
