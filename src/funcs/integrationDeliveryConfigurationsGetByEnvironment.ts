 ...
 * Get delivery configurations by environment.
 */
export function integrationDeliveryConfigurationsGetByEnvironment(
  client: LaunchDarklyCore,
  request: operations.GetIntegrationDeliveryConfigurationByEnvironmentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationDeliveryConfigurationCollection,
...
> {
  ...
  >(
    M.json(
      200,
      components.IntegrationDeliveryConfigurationCollection$inboundSchema,
    ),
