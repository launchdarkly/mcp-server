 ...
 */
export function insightsChartsBetaGetLeadTimeChart(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetLeadTimeChartRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/charts/lead-time")();
