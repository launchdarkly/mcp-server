 ...
 */
export function contextSettingsPutContextFlagSetting(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PutContextFlagSettingRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ValuePut, { explode: true });
  ...
  const pathParams = {
    ...
    contextKind: encodeSimple("contextKind", payload.contextKind, {
      explode: false,
      charEncoding: "percent",
    }),
