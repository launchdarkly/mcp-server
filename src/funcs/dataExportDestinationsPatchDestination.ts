 ...
 */
export function dataExportDestinationsPatchDestination(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchDestinationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.Destination$inboundSchema),
