 ...
 */
export function segmentsCreateBigSegmentImport(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateBigSegmentImportRequest$outboundSchema.parse(value),
  ...
  if (payload.RequestBody.mode !== undefined) {
    appendForm(body, "mode", payload.RequestBody.mode);
  }
  if (payload.RequestBody.waitOnApprovals !== undefined) {
    appendForm(body, "waitOnApprovals", payload.RequestBody.waitOnApprovals);
  }
