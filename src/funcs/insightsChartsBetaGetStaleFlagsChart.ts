...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetStaleFlagsChartRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/charts/flags/stale")();
  ...
  const query = encodeFormQuery({
    ...
    "maintainerTeamKey": payload.maintainerTeamKey,
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.InsightsChart$inboundSchema),
