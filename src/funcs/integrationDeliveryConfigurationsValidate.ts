 ...
 */
export function integrationDeliveryConfigurationsValidate(
  client: LaunchDarklyCore,
  request: operations.ValidateIntegrationDeliveryConfigurationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationDeliveryConfigurationResponse,
...
> {
  ...
  >(
    M.json(
      200,
      components.IntegrationDeliveryConfigurationResponse$inboundSchema,
    ),
