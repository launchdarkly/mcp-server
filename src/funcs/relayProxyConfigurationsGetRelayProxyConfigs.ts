 ...
 */
export function relayProxyConfigurationsGetRelayProxyConfigs(
  client: LaunchdarklyMcpServerCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.RelayAutoConfigCollectionRep,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.RelayAutoConfigCollectionRep$inboundSchema),
