 ...
 */
export function releasesBetaUpdatePhaseStatus(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdatePhaseStatusRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdatePhaseStatusInput, {
    explode: true,
  });
