 ...
 */
export function usersGetSearchUsers(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSearchUsersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/user-search/{projectKey}/{environmentKey}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.Users$inboundSchema),
