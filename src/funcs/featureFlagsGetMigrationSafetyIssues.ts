 ...
 */
export function featureFlagsGetMigrationSafetyIssues(
  client: LaunchDarklyCore,
  request: operations.PostMigrationSafetyIssuesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<components.MigrationSafetyIssueRep> | undefined,
    ...
    | errors.StatusServiceUnavailableError
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostMigrationSafetyIssuesRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.flagSempatch, { explode: true });
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "403", "404", "429", "4XX", "503", "5XX"],
  ...
  >(
    M.json(
      200,
      z.array(components.MigrationSafetyIssueRep$inboundSchema).optional(),
    ),
    M.nil(
      204,
      z.array(components.MigrationSafetyIssueRep$inboundSchema).optional(),
    ...
    M.jsonErr(503, errors.StatusServiceUnavailableError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
