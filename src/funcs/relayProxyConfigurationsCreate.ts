 ...
 */
export function relayProxyConfigurationsCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.RelayAutoConfigPost$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/account/relay-auto-configs")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.RelayAutoConfigRep$inboundSchema),
