 ...
 */
export function featureFlagsPostMigrationSafetyIssues(
  client: LaunchdarklyMcpServerCore,
  request: operations.PostMigrationSafetyIssuesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<models.MigrationSafetyIssueRep> | undefined,
...
> {
  ...
  >(
    M.json(
      200,
      z.array(models.MigrationSafetyIssueRep$inboundSchema).optional(),
    ),
    M.nil(
      204,
      z.array(models.MigrationSafetyIssueRep$inboundSchema).optional(),
