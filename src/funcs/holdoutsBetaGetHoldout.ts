...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetHoldoutRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.HoldoutDetailRep$inboundSchema),
