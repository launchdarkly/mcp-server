 ...
 */
export function relayProxyConfigurationsPatchRelayAutoConfig(
  client: LaunchdarklyMcpServerCore,
  request: operations.PatchRelayAutoConfigRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.RelayAutoConfigRep,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchRelayAutoConfigRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/account/relay-auto-configs/{id}")(
    pathParams,
  );
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "404", "409", "422", "429", "4XX", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.RelayAutoConfigRep$inboundSchema),
