 ...
 */
export function webhooksPatchWebhook(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchWebhookRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/webhooks/{id}")(pathParams);
