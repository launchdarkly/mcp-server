...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApprovalRequestReviewRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.postApprovalRequestReviewRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v2/approval-requests/{id}/reviews")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ApprovalRequestResponse$inboundSchema),
