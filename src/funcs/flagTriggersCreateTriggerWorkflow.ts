 ...
 */
export function flagTriggersCreateTriggerWorkflow(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateTriggerWorkflowRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.triggerPost, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.TriggerWorkflowRep$inboundSchema),
