 ...
 */
export function projectsPatchProject(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchProjectRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/projects/{projectKey}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ProjectRep$inboundSchema),
