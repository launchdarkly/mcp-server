 ...
 */
export function segmentsUpdateBigSegmentContextTargets(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateBigSegmentContextTargetsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.SegmentUserState, { explode: true });
