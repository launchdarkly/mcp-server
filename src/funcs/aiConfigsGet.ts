...
import { GetAIConfigServerList } from "../models/operations/getaiconfig.js";
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAIConfigRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAIConfigServerList[0], { charEncoding: "percent" })();
