 ...
 */
export function followFlagsListFollowers(
  client: LaunchDarklyCore,
  request: operations.GetFlagFollowersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.FlagFollowersGetRep,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFlagFollowersRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FlagFollowersGetRep$inboundSchema),
