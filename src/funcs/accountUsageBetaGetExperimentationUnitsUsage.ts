 ...
 */
export function accountUsageBetaGetExperimentationUnitsUsage(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetExperimentationUnitsUsageRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/api/v2/usage/experimentation-units")();
