 ...
 */
export function contextsPerformSearch(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SearchContextsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ContextSearch, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.Contexts$inboundSchema),
