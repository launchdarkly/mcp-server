 ...
 * Get delivery configurations by environment.
 */
export function integrationDeliveryConfigurationsBetaGetIntegrationDeliveryConfigurationByEnvironment(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetIntegrationDeliveryConfigurationByEnvironmentRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.IntegrationDeliveryConfigurationCollection,
...
> {
  ...
  >(
    M.json(
      200,
      models.IntegrationDeliveryConfigurationCollection$inboundSchema,
    ),
