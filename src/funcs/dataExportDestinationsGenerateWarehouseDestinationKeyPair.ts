 ...
 */
export function dataExportDestinationsGenerateWarehouseDestinationKeyPair(
  client: LaunchDarklyCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.GenerateWarehouseDestinationKeyPairPostRep,
...
> {
  ...
  >(
    M.json(
      201,
      components.GenerateWarehouseDestinationKeyPairPostRep$inboundSchema,
    ),
