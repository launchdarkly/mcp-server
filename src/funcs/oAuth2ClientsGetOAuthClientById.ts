 ...
 */
export function oAuth2ClientsGetOAuthClientById(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetOAuthClientByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/oauth/clients/{clientId}")(pathParams);
