 ...
 */
export function approvalsReviewFlagRequest(
  client: LaunchDarklyCore,
  request: operations.PostApprovalRequestReviewForFlagRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.FlagConfigApprovalRequestResponse,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.FlagConfigApprovalRequestResponse$inboundSchema),
