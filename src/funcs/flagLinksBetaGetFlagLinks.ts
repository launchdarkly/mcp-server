...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFlagLinksRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagLinkCollectionRep$inboundSchema),
