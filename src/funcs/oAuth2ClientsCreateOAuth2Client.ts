 ...
 */
export function oAuth2ClientsCreateOAuth2Client(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.OauthClientPost$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/oauth/clients")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.Client$inboundSchema),
