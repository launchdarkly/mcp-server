 ...
 */
export function accessTokensGetTokens(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetTokensRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/tokens")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.Tokens$inboundSchema),
