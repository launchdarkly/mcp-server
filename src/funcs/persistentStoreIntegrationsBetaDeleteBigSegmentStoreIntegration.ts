 ...
 */
export function persistentStoreIntegrationsBetaDeleteBigSegmentStoreIntegration(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteBigSegmentStoreIntegrationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "403", "404", "409", "429", "4XX", "5XX"],
