 ...
 * List all flag import configurations.
 */
export function flagImportConfigurationsBetaGetFlagImportConfigurations(
  client: LaunchdarklyMcpServerCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FlagImportIntegrationCollection,
...
> {
  const path = pathToFunc("/api/v2/integration-capabilities/flag-import")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagImportIntegrationCollection$inboundSchema),
