 ...
 */
export function relayProxyConfigurationsResetRelayAutoConfig(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ResetRelayAutoConfigRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/account/relay-auto-configs/{id}/reset")(
    pathParams,
  );
