 ...
 */
export function flagImportConfigurationsBetaCreateFlagImportConfiguration(
  client: LaunchdarklyMcpServerCore,
  request: operations.CreateFlagImportConfigurationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.FlagImportIntegration,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateFlagImportConfigurationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.FlagImportConfigurationPost, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagImportIntegration$inboundSchema),
