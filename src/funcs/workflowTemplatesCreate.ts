...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.CreateWorkflowTemplateInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.WorkflowTemplateOutput$inboundSchema),
