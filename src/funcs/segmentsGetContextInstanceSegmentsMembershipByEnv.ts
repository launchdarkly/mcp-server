 ...
 */
export function segmentsGetContextInstanceSegmentsMembershipByEnv(
  client: LaunchdarklyMcpServerCore,
  request: operations.GetContextInstanceSegmentsMembershipByEnvRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.ContextInstanceSegmentMemberships,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetContextInstanceSegmentsMembershipByEnvRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.ContextInstanceSegmentMemberships$inboundSchema),
