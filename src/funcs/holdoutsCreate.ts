 ...
 */
export function holdoutsCreate(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostHoldoutRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.HoldoutPostRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.HoldoutRep$inboundSchema),
