 ...
 */
export function integrationsCreateConfiguration(
  client: LaunchDarklyCore,
  request: operations.CreateIntegrationConfigurationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.IntegrationConfigurationsRep,
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.IntegrationConfigurationsRep$inboundSchema),
