...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetFeatureFlagStatusesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FeatureFlagStatuses$inboundSchema),
