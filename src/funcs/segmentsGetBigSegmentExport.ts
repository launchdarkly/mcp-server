 ...
 */
export function segmentsGetBigSegmentExport(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetBigSegmentExportRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    exportID: encodeSimple("exportID", payload.exportID, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.Export$inboundSchema),
