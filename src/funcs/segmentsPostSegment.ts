 ...
 */
export function segmentsPostSegment(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostSegmentRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.SegmentBody, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.UserSegment$inboundSchema),
