 ...
 */
export function integrationAuditLogSubscriptionsCreateSubscription(
...
> {
  ...
  const body = encodeJSON("body", payload.subscriptionPost, { explode: true });
  ...
  const path = pathToFunc("/api/v2/integrations/{integrationKey}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.Integration$inboundSchema),
