...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchMetricGroupRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.MetricGroupRep$inboundSchema),
