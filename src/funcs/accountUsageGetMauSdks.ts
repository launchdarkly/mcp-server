...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMauSdksByTypeRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/usage/mau/sdks")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.SDKListRep$inboundSchema),
