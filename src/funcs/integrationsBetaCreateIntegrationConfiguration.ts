 ...
 */
export function integrationsBetaCreateIntegrationConfiguration(
  client: LaunchdarklyMcpServerCore,
  request: operations.CreateIntegrationConfigurationRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    models.IntegrationConfigurationsRep,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateIntegrationConfigurationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON("body", payload.IntegrationConfigurationPost, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.IntegrationConfigurationsRep$inboundSchema),
