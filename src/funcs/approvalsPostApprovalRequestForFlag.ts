 ...
 */
export function approvalsPostApprovalRequestForFlag(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApprovalRequestForFlagRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON(
    "body",
    payload.createFlagConfigApprovalRequestRequest,
    { explode: true },
  );
