 ...
 */
export function approvalsPostApprovalRequestApply(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostApprovalRequestApplyRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.postApprovalRequestApplyRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/api/v2/approval-requests/{id}/apply")(pathParams);
