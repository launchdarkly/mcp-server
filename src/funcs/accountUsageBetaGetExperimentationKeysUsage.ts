...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetExperimentationKeysUsageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/usage/experimentation-keys")();
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "401", "403", "429", "4XX", "503", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.SeriesIntervalsRep$inboundSchema),
