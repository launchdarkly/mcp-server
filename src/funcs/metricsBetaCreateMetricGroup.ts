 ...
 */
export function metricsBetaCreateMetricGroup(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateMetricGroupRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.MetricGroupPost, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.MetricGroupRep$inboundSchema),
