 ...
 * Create insight group
 */
export function insightsScoresCreateGroup(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.PostInsightGroupParams$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/api/v2/engineering-insights/insights/group")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.InsightGroup$inboundSchema),
