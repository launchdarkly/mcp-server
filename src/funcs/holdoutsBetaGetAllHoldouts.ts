...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllHoldoutsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.HoldoutsCollectionRep$inboundSchema),
