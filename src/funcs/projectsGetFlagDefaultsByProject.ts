...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetFlagDefaultsByProjectRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, models.FlagDefaultsRep$inboundSchema),
