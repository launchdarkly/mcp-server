 ...
 */
export function integrationDeliveryConfigurationsBetaCreateIntegrationDeliveryConfiguration(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateIntegrationDeliveryConfigurationRequest$outboundSchema
        .parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, models.IntegrationDeliveryConfiguration$inboundSchema),
